...
if(isset($_POST['submit'])){
 ...
 $query = mysqli_query($connect, "SELECT * FROM user  WHERE password='$password' AND username='$username'"); //tambah semicolon pada hujung baris kod
 $rows = mysqli_num_rows($query);
 if($rows == 1){
 header("Location: maklumatbot"); 
 }
 else
 {
